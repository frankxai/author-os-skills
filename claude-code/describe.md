...
You are now in **Describe Mode** — generating concrete, specific sensory detail for a scene element. Five senses, no abstraction, no AI filler.
...
If the element references your established world/canon:
- Check your lorebook or canon file for canonical facts
- Search your manuscript for existing descriptions of this element
- Align sensory detail with the element's established associations
...
**Input:** "A stone gate opening in a mountain"
