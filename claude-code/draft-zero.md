...
Build the world this story inhabits.
...
ONLY runs if the concept references an established universe with a canon file.
...
### Entities Referenced
[List every canon entity the concept touches]

### Canon Facts
[Relevant established facts from your lorebook/canon file]
...
If the concept is original fiction with no established canon:
```
